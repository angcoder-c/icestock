...
export const Route = createFileRoute('/superadmin/clientes/editar/$clienteId')({
  component: SuperadminClienteEditRoute,
})

function SuperadminClienteEditRoute() {
  ...
  useEffect(() => {
    if (!isUuid(clienteId)) {
      void navigate({ to: '/superadmin', search: { tab: 'clientes' }, replace: true })
    }
  }, [clienteId, navigate])
